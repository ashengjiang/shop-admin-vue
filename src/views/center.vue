  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='shangjia'"  label="店长账号" prop="dianzhangzhanghao">
          <el-input v-model="ruleForm.dianzhangzhanghao" readonly              placeholder="店长账号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='shangjia'"  label="店长姓名" prop="dianzhangxingming">
          <el-input v-model="ruleForm.dianzhangxingming"               placeholder="店长姓名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'shangjia' ==this.flag && this.ruleForm.lianxidianhua&&(!isPhone(this.ruleForm.lianxidianhua))){
