      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   <div class="label">店长账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.dianzhangzhanghao" class="input" type="text" placeholder="店长账号">
			   </div>
			 </div> -->
			<el-form-item label="店长账号" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.dianzhangzhanghao" autocomplete="off" placeholder="店长账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.dianzhangxingming" class="input" type="text" placeholder="店长姓名">
			   </div>
			 </div> -->
			<el-form-item label="店长姓名" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.dianzhangxingming" autocomplete="off" placeholder="店长姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
