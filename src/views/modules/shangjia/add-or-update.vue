<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="店长账号" prop="dianzhangzhanghao">
          <el-input v-model="ruleForm.dianzhangzhanghao" 
              placeholder="店长账号" clearable  :readonly="ro.dianzhangzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="店长账号" prop="dianzhangzhanghao">
              <el-input v-model="ruleForm.dianzhangzhanghao" 
                placeholder="店长账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="店长姓名" prop="dianzhangxingming">
          <el-input v-model="ruleForm.dianzhangxingming" 
              placeholder="店长姓名" clearable  :readonly="ro.dianzhangxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="店长姓名" prop="dianzhangxingming">
              <el-input v-model="ruleForm.dianzhangxingming" 
