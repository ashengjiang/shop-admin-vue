  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.dianzhangzhanghao!=''&&json.dianzhangzhanghao){
                this.ruleForm.dianzhangzhanghao = json.dianzhangzhanghao
	    		this.ro.dianzhangzhanghao = true;
		}
	...
	this.ruleForm.shangpinxiangqing = this.ruleForm.shangpinxiangqing.replace(reg,'../../../springbootsk8bh/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
