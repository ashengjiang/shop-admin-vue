<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商户名称" prop="dianzhangzhanghao">
          <el-input v-model="ruleForm.dianzhangzhanghao" 
              placeholder="商户名称" clearable  :readonly="ro.dianzhangzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商户名称" prop="dianzhangzhanghao">
              <el-input v-model="ruleForm.dianzhangzhanghao" 
...
export default {
  ...
  methods: {
	...
	this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../springbootsk8bh/upload');
        } else {
